...
public class MainActivity extends Activity implements OnClickListener {
	...
	SpannableString Breakfast = new SpannableString("Breakfast");
	SpannableString Lunch = new SpannableString("Lunch");
	SpannableString Dinner = new SpannableString("Dinner");
	int day = 0, time = 0, width = 0, height = 0;
	...
	public void onConfigurationChanged(Configuration newConfig) {
	   ...
	   // float scale = getResources().getDisplayMetrics().density;
	    //int dpAsPixels = (int) (0*scale + 0.5f);
	    ...
	    if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
	    	...
	    	tl.setLayoutParams(new TableLayout.LayoutParams(dpAsPixels, TableLayout.LayoutParams.MATCH_PARENT,1));
	    	llpadme.setLayoutParams(new LinearLayout.LayoutParams(TableLayout.LinearParams.WRAP_CONTENT, TableLayout.LinearParams.WRAP_CONTENT,1.1f));
	    	*/
	    	for(int i =0; i<6; i++)
        	{
	    	...
	    	tl.setLayoutParams(new TableLayout.LayoutParams(dpAsPixels, TableLayout.LayoutParams.MATCH_PARENT));
	    	llpadme.setLayoutParams(new TableLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT));
	    	*/
	    	for(int i =0; i<6; i++)
        	{
        		LinearLayout.LayoutParams params = (LinearLayout.LayoutParams)tblRow[i].getLayoutParams();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else
        {
	        ...
	        {
	        	//Without Percent Margins
	        	/*
	        	ll.setOrientation(LinearLayout.HORIZONTAL);
		    	llbuttons.setOrientation(LinearLayout.VERTICAL);
		    	tl.setLayoutParams(new TableLayout.LayoutParams(dpAsPixels, TableLayout.LayoutParams.MATCH_PARENT,1));
		    	llpadme.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT,1.1f));
		    	*/
	        	//With
	        	for(int i =0; i<6; i++)
	        	{
	        ...
	        else if(ot == Configuration.ORIENTATION_PORTRAIT)
	        {
		    	...
		    	llbuttons.setOrientation(LinearLayout.HORIZONTAL);
		    	tl.setLayoutParams(new TableLayout.LayoutParams(dpAsPixels, TableLayout.LayoutParams.MATCH_PARENT));
		    	llpadme.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT));
		    	*/
	        	//With
	        	for(int i =0; i<6; i++)
	        	{
